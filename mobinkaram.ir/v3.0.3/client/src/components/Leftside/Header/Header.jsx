...
const Header = () => {
  return (
    <>
      <div className="lg:h-screen lg:p-26px p-10px absolute w-full bottom-0 lg:relative bg-slate-900 flex item-center justify-between lg:flex-col flex-nowrap">
        <div className="">
        ...
        <div className="w-full flex item-center justify-center lg:flex-col flex-row flex-nowrap">
          <div className="w-full flex item-center justify-center flex-row flex-nowrap lg:mt-20px">
            <Link to={"/"}>
              <span className="text-gray-200 hover:text-cyan-500 text-xl">
                Home
              </span>
            </Link>
          </div>
